...
/** addInvokeCount POST /api/userInterfaceInfo/addInvokeCount */
export async function addInvokeCountUsingPOST(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: { userId: number; interfaceInfoId: number },
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseboolean>('/api/userInterfaceInfo/addInvokeCount', {
    method: 'POST',
    params: {
      ...params,
    },
